...
> **带宽**：按 `rows * cols * sizeof(float) * 3` / 时间 估算（与仓库内部分 `*.cu` 计时脚本一致），单位为 **GB/s**。
...
|------|------|------|------|------|------|-----|
| 128 | 128 | 7.0 | 19.4 | 28.2 | **29.5** | 14.5 |
| 256 | 256 | 9.3 | 50.3 | 45.0 | **84.5** | 49.0 |
| 512 | 512 | 19.1 | 275.7 | 213.9 | **307.0** | 245.3 |
| 1024 | 1024 | 38.5 | 749.3 | 1023.0 | **1048.9** | 497.4 |
| 4096 | 4096 | 159.5 | 578.5 | 570.7 | **579.3** | 389.1 |
