...
|--------------|-------|-------|-------|-------|--------|
| 256³ | 0.034 | 0.033 | 0.029 | 0.023 | 0.023 |
| 512³ | 0.186 | 0.191 | 0.059 | 0.043 | 0.037 |
| 1024³ | 1.370 | 1.542 | 0.292 | 0.242 | 0.161 |
| 2048³ | 11.26 | 11.83 | 1.589 | 1.663 | 1.092 |
| 4096³ | N/A | N/A | 13.11 | 13.28 | ~8.5 |

### 性能吞吐量对比 (GFLOPS)

| 规模 (M×N×K) | V0 | V1 | V2 | V3 | cuBLAS |
|--------------|------|------|------|------|--------|
| 256³ | 982 | 1,011 | 1,140 | **1,443** | 1,495 |
| 512³ | 1,442 | 1,404 | **4,589** | 6,179 | 7,148 |
| 1024³ | 1,567 | 1,393 | 7,352 | **8,866** | **13,343** |
| 2048³ | 1,524 | 1,450 | 10,813 | 10,328 | **15,724** |
| 4096³ | N/A | N/A | 10,483 | 10,346 | **16,170** |
...
3. **大矩阵 (1024³~4096³)**：cuBLAS 性能最优，V3 达到 cuBLAS 的 64-66%
4. **优化效果**：V3 相比 V0 加速 7-8×
